"""
Storage abstraction do backend datahidro — cópia de levabici/backend/storage.py
(que é cópia do amora; mesma interface StateStore — bug corrigido num, corrige nos outros).

Roteia o ESTADO MUTÁVEL por trás de uma interface comum:
...
Estado mutável: respostas/<uuid>.ttl (uma resposta por objeto; bucket PRIVADO).
